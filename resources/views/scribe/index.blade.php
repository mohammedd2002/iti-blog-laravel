                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-posts--id-">GET api/posts/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-sanctum-token">
                                <a href="#endpoints-POSTapi-sanctum-token">POST api/sanctum/token</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="bash-example">
    ...
    --form "title=vmqeopfuudtdsufvyvddqamniihfqcoynlazghdtqtqxbajwbpilpmufinllwloauydlsmsjur"\
    --form "description=Vel natus ex dicta hic inventore asperiores illum est."\
    --form "user_id=consequatur"\
    --form "image=@C:\Users\mamah\AppData\Local\Temp\phpDC32.tmp" </code></pre></div>
...
body.append('title', 'vmqeopfuudtdsufvyvddqamniihfqcoynlazghdtqtqxbajwbpilpmufinllwloauydlsmsjur');
body.append('description', 'Vel natus ex dicta hic inventore asperiores illum est.');
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Vel natus ex dicta hic inventore asperiores illum est."
               data-component="body">
    <br>
<p>Must be at least 10 characters. Example: <code>Vel natus ex dicta hic inventore asperiores illum est.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\mamah\AppData\Local\Temp\phpDC32.tmp</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/posts/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the post. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-sanctum-token">POST api/sanctum/token</h2>
...
<span id="example-requests-POSTapi-sanctum-token">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-sanctum-token">
</span>
<span id="execution-results-POSTapi-sanctum-token" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-sanctum-token"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-sanctum-token"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-sanctum-token" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-sanctum-token">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-sanctum-token" data-method="POST"
      data-path="api/sanctum/token"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-sanctum-token', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-sanctum-token"
                    onclick="tryItOut('POSTapi-sanctum-token');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-sanctum-token"
                    onclick="cancelTryOut('POSTapi-sanctum-token');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-sanctum-token"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-sanctum-token"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-sanctum-token"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
